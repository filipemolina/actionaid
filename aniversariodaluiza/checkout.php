...
$data['shippingAddressState'] = strtoupper($estado); // UF do comprador
...
$insert = $con->query("INSERT INTO users_payement (user_id, nome, email, cep, endereco, numero, complemento, bairro, cidade, estado, telefone, celular, valor_doacao, status, cod_transacao, newsletter_email, newsletter_celular, created) VALUES ('".$user_id."', '".$nome."', '".$email."', '".$cep."', '".$endereco."', '".$numero."', '".$complemento."', '".$bairro."', '".$cidade."', '".$estado."', '".$telefone."', '".$celular."', '".$valor_doacao."', '".$status."', '".$cod_transacao."', '".$newsletter_email."', '".$newsletter_email."', NOW())");
echo $xml->code;
